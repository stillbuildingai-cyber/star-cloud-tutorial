                ...
                <tbody class="divide-y divide-slate-50 dark:divide-slate-800/80">
                    @foreach($machines as $machine)
                        <tr
                            ...
                            <td class="px-6 py-6 cursor-pointer" @click="selectMachine({{ Js::from($machine->only(['id', 'name', 'serial_no', 'image_urls'])) }})">
                            ...
                            <td class="px-6 py-6 text-right">
                                <button @click="selectMachine({{ Js::from($machine->only(['id', 'name', 'serial_no', 'image_urls'])) }})"
